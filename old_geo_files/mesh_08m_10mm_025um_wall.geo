...
Point( 8) = {     0.0,        flame_pos + 0.33*delta, 0., 0.5*clF};
Point( 9) = {     0.0,        flame_pos + 0.66*delta, 0., 0.5*clF};
...
/*material*/
Transfinite Line {-50} = 13 Using Progression 1.075;
Transfinite Line { 52} = 13 Using Progression 1.075;
Transfinite Line { 53} = 13 Using Progression 1.075;
Transfinite Line {-58} = 13 Using Progression 1.075;
Transfinite Line { 59} = 13 Using Progression 1.075;
Transfinite Line {-60} = 13 Using Progression 1.075;

Transfinite Line { 26} = 31 Using Progression 1.005;
Transfinite Line { 54} = 31 Using Progression 1.020;
/*Transfinite Line { 66} = 31 Using Progression 1.033;*/

Transfinite Line {-23} = 31 Using Progression 1.00;
