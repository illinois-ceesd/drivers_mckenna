...
Point(1) = {ext_radius, burner_height, 0.0, 0.000200};
Point(2) = {int_radius, burner_height, 0.0, 1.0};
Point(3) = {            0.005, burner_height, 0.0, 1.0};
Point(4) = {               0., burner_height, 0.0, 1.0};

delta = (mat_location - mat_BL_layer - burner_height - flame_dist);
flame_pos = burner_height + flame_dist;

Point( 5) = {     0.0,        flame_pos + 0.33*delta, 0.,     clS};
Point( 6) = {     0.0,        flame_pos + 0.66*delta, 0.,     clS};
Point( 7) = {     0.0, mat_location - mat_BL_layer, 0.,     clS};
Point( 8) = {     0.0, mat_location                 , 0., 0.7*clS};
Point( 9) = {mat_wide-0.002, mat_location           , 0.,     clM};
Point(10) = {mat_wide-0.002, mat_location + 0.002    , 0.,     clM};
Point(11) = {mat_wide,      mat_location + 0.002    , 0.,     clM};
...
Point(17) = {     0.0, mat_location + 1.0*mat_holder + mat_BL_layer, 0., 1.4142*clS};
...
Point(41) = {mat_wide - 0.002       , mat_location - mat_BL_layer, 0.,1.0};
Point(42) = {mat_wide + mat_BL_layer, mat_location + 0.002    , 0.,     clM};
Point(43) = {mat_wide + mat_BL_layer, mat_location + mat_thick, 0., 1.0};
Point(44) = {mat_wide + mat_BL_layer, mat_location + insulator, 0., 1.0};
Point(45) = {mat_wide + mat_BL_layer, mat_location + 1.0*mat_holder + mat_BL_layer, 0., 1.0};
...
/*vertical*/
Transfinite Line {  3} = 28 Using Progression 1.1;
Transfinite Line { 16} = 28 Using Progression 1.1;
Transfinite Line { 13} = 28 Using Progression 1.0;
Transfinite Line { 10} = 28 Using Progression 1.0;
Transfinite Line {  4} = 28 Using Progression 1.1;
Transfinite Line {  6} = 28 Using Progression 1.1;
...
/*material*/
Transfinite Line { 48} = 13 Using Progression 1.100;
...
Transfinite Line { 26} = 31 Using Progression 1.015;
Transfinite Line { 54} = 31 Using Progression 1.015;
/*Transfinite Line { 66} = 31 Using Progression 1.033;*/

Transfinite Line { 23} = 31 Using Progression 1.0;
Transfinite Line {-51} = 31 Using Progression 1.0;
/*Transfinite Line {-67} = 31 Using Progression 1.02;*/

Transfinite Line { 49} = 15 Using Bump 0.8;
Transfinite Line { 24} = 15 Using Bump 0.8;
...
Transfinite Line { 57} = 18 Using Progression 1.0;
Transfinite Line {-29} = 18 Using Progression 1.02;

Line Loop(41) = {10:12,17:24,26:29,31,32,40:44};
Plane Surface(1) = {41};
...
Point(89) = {  0.0150, mat_location - 0.00350, 0., 0.250*clF};
Point(90) = {  0.0170, mat_location - 0.0030, 0., 0.250*clF};
Point(91) = {  0.0181, mat_location - 0.0023, 0., 0.250*clF};
Point(92) = {  0.0190, mat_location - 0.00140, 0., 0.250*clF};
Point(93) = {  0.0195, mat_location + 0.00055, 0., 0.250*clF};
Point{89:93} In Surface{1};
...
Line Loop(62) = {51,52,-23,50};
Plane Surface(10) = {62};
Transfinite Surface {10} Alternate;

Line Loop(63) = {-52,49,48,-24};
Plane Surface(11) = {63};
Transfinite Surface {11} Alternate;

Line Loop(64) = {-53, -54, 48, 26};
Plane Surface(12) = {-64};
...
Physical Line("wall") = {49,51,54,55,56,57};
Physical Surface("fluid") = {1:6,10:15};
