...
Point( 9) = {mat_wide-0.001, mat_location           , 0.,     clM};
Point(10) = {mat_wide-0.001, mat_location +0.001    , 0.,     clM};
Point(11) = {mat_wide,      mat_location +0.001    , 0.,     clM};
Point(13) = {mat_wide,      mat_location + mat_thick, 0., 1.4142*clM};
...
Point(41) = {mat_wide - 0.001       , mat_location - mat_BL_layer, 0.,1.0};
Point(42) = {mat_wide + mat_BL_layer, mat_location + 0.001    , 0.,     clM};
...
Point(51) = {insulator_wide, mat_location + insulator, 0., 1.4142*clM};
Point(52) = {           0.0, mat_location + insulator, 0., clM};
Point(53) = {           0.0, mat_location + mat_thick, 0., clM};
Point(54) = {insulator_wide, mat_location + mat_thick, 0., 1.4142*clM};
...
Transfinite Line { 49} = 11 Using Progression 1.0;
Transfinite Line { 24} = 11 Using Progression 1.0;
...
Line Loop(68) = {-54,-49,-51,63,68,64};
Plane Surface(16) = {68};
