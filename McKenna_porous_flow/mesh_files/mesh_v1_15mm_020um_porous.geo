...
Point(54) = {insulator_wide, mat_location + mat_thick, 0., 0.8*clM};
...
/*Transfinite Line { 57} = 19 Using Progression 1.0;*/
Transfinite Line {-64} = 5 Using Progression 1.2;
...
Line Loop(70) = {56,57,65,-66,-62};
Plane Surface(18) = {-70};

Line Loop(71) = {62,-69,64,55};
Plane Surface(19) = {-71};

/*#########################*/

Physical Line("inlet") = {1,2,5};
Physical Line("symmetry") = {6,20:22,50,31,32,59,63};
...
Physical Surface("sample") = {16};
Physical Surface("wall_alumina") = {17};
Physical Surface("wall_graphite") = {18, 19};
