...
mat_BL_layer_x = 0.0035;
mat_BL_layer_y = 0.0035;
...
Transfinite Line { 26} = 41 Using Progression 1.005;
Transfinite Line { 54} = 41 Using Progression 1.010;
...
Transfinite Line { 24} = 31 Using Progression 1.002;
...
Transfinite Line {-64} =  5 Using Progression 1.10;
...
Line Loop(41) = {10:12,17:19,23:24,26:29,31,32,40:44};
Plane Surface(1) = {41};
...
Physical Line("fluid_sample_coupling") = {51,54};
Physical Line("fluid_holder_coupling") = {55,56,57};
