...
/*Point(55) = {mat_wide,      mat_location + mat_thick, 0.,     clM};*/
/*Point(56) = {           0.0, mat_location + mat_thick, 0., clM};*/
/*Point(57) = {insulator_wide, mat_location + mat_thick, 0., clM};*/
Line(70) = {13, 54};
Line(71) = {54, 53};

Transfinite Line { 70} = 4 Using Progression 1.0;
Transfinite Line { 71} = 10 Using Progression 1.0;

Transfinite Line { 62} = 20 Using Progression 1.0;
/*Transfinite Line { 68} = 13 Using Progression 1.0;*/
...
Transfinite Line { 23} = 31 Using Progression 1.002;
...
Line Loop(68) = {-54,-51,63,-62};
Plane Surface(16) = {68};
/*Transfinite Surface {16} Right;*/

Line Loop(69) = {66,67,-71,69};
Plane Surface(17) = {-69};

Line Loop(70) = {55,56,57,65,-66,-69,-70};
Plane Surface(18) = {-70};
...
Physical Line("sample_int") = {62};
Physical Line("holder_int") = {70,71};
