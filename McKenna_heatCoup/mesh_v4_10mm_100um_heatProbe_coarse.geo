...
Point(26) = {burner_base_radius, burner_height-0.0110, 0.0, 0.8*clB};
...
Point(40) = {mat_wide           ,                     - mat_BL_y + mat_location, 0., 1.};
Point(41) = {mat_wide + mat_BL_x*Cos(Pi/4), - Cos(Pi/4)*mat_BL_y + mat_location, 0., 1.};
Point(42) = {mat_wide + mat_BL_x          , mat_location, 0., 1.};
...
Transfinite Line { 23} = 20 Using Progression 1.00;
Transfinite Line { 24} =  7 Using Progression 1.00;
Transfinite Line {-51} = 26 Using Progression 1.025;

/*Transfinite Line { 26} = 19 Using Progression 1.052;*/
Transfinite Line { 25} =  6 Using Progression 1.052;
Transfinite Line { 26} = 14 Using Progression 1.052;
Transfinite Line { 54} = 19 Using Progression 1.075;

/*vertical*/
Transfinite Line {  3} = 26 Using Progression 1.05;
Transfinite Line { 16} = 26 Using Progression 1.05;
Transfinite Line {  4} = 26 Using Progression 1.05;
Transfinite Line {  6} = 26 Using Progression 1.05;
Transfinite Line { 13} = 26 Using Progression 1.0;
...
/*material*/
Transfinite Line {-50} = 16 Using Progression 1.12;
Transfinite Line { 52} = 16 Using Progression 1.06;
Transfinite Line { 53} = 16 Using Progression 1.12;
Transfinite Line {-58} = 16 Using Progression 1.12;
Transfinite Line {-60} = 16 Using Progression 1.12;
Transfinite Line { 66} = 16 Using Progression 1.12;
Transfinite Line { 59} = 16 Using Progression 1.12;
...
Point(105) = {        0.           ,  -0.000200 + mat_location , 0., 1.0};


Line Loop(40) = {10:12,17:19,22:31,41:44};
Plane Surface(1) = {40};
...
Line Loop(50) = {51,52,-24,-23,50};
Plane Surface(11) = {50};
Transfinite Surface {11} = {11, 12, 41, 10} Alternate;

Line Loop(51) = {-53, -54, 52, 25, 26};
Plane Surface(12) = {-51};
Transfinite Surface {12} = {43,13,12,41} Alternate;
