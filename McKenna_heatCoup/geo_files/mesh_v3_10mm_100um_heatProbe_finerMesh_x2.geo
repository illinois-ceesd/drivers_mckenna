...
mat_wide = 0.5*1.25*25.4/1000 * 2.0;
...
Transfinite Line { 23} = 51 Using Progression 1.00;
Transfinite Line {-50} =  7 Using Progression 1.00;
Transfinite Line {-51} = 45 Using Progression 1.005;
...
Transfinite Line { 57} = 29 Using Progression 1.00;
Transfinite Line {-29} = 29 Using Progression 1.001;
...
Field[4] = Box;
Field[4].XMax = 0.04 + mat_wide/2.0;
Field[4].XMin = 0.016 + mat_wide/2.0;
Field[4].YMax = 0.16;
Field[4].YMin = 0.10;
Field[4].ZMax = -1;
Field[4].ZMin = 1;
...
Field[5] = Box;
Field[5].XMax = 0.06 + mat_wide/2.0;
Field[5].XMin = 0.016 + mat_wide/2.0;
Field[5].YMax = 0.215;
Field[5].YMin = 0.10;
Field[5].ZMax = -1;
Field[5].ZMin = 1;
...
Field[1] = Box;
Field[1].XMax = 0.08 + mat_wide/2.0;
Field[1].XMin = 0.0;
Field[1].YMax = 0.25;
Field[1].YMin = 0.105;
Field[1].ZMax = -1;
...
Field[2] = Box;
Field[2].XMax = 0.12 + mat_wide/2.0;
Field[2].XMin = 0.0;
Field[2].YMax = 0.375;
Field[2].YMin = 0.1;
Field[2].ZMax = -1;
...
Field[3] = Box;
Field[3].XMax = 0.16 + mat_wide/2.0;
Field[3].XMin = 0.0;
Field[3].YMax = 0.5;
Field[3].YMin = 0.2;
Field[3].ZMax = -1;
