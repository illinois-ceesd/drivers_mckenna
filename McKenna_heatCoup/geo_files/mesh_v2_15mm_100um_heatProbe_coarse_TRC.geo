...
Point(57) = {  x3, mat_location, 0., clM/2.0}; 
...
Transfinite Line {- 5} = 24 Using Progression 1.00;
Transfinite Line {-19} = 24 Using Progression 1.00;
Transfinite Line { 23} = 24 Using Progression 1.00;
Transfinite Line {-51} = 19 Using Progression 1.00;
Transfinite Line {-50} =  6 Using Progression 1.00;
...
Line Loop(50) = {51,52,-23,50,49};
Plane Surface(11) = {50};
Transfinite Surface {11} = {12,41,10,11} Right;
...
Line Loop(60) = {62,63,69,-50,61};
Plane Surface(20) = {60};

Line Loop(61) = {-69,64,65,-57,-56,-55,-54,-51};
Plane Surface(21) = {61};
...
Physical Surface("slug") = {20};
Physical Surface("holder") = {21};
