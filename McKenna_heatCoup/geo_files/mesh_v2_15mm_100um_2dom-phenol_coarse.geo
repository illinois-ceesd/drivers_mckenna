...
Point(13) = {mat_wide,      mat_location + mat_thick, 0., 0.75*clM};
Point(14) = {mat_wide,      mat_location + insulator, 0.,     1.0};

Point(15) = {mat_wide,                  mat_location + 1.*mat_holder, 0., 1.00};
Point(16) = {     0.0,                  mat_location + 1.*mat_holder, 0.,  clM};
Point(17) = {     0.0, mat_BL_layer_y + mat_location + 1.*mat_holder, 0., 1.5*clS};
...
Point(51) = {insulator_wide, mat_location + insulator, 0., 0.95*clM};
Point(52) = {           0.0, mat_location + insulator, 0., clM};
Point(53) = {           0.0, mat_location + mat_thick, 0., clM};
Point(54) = {insulator_wide, mat_location + mat_thick, 0., 0.75*clM};
...
Transfinite Line {- 5} = 27 Using Progression 1.00;
Transfinite Line {-19} = 27 Using Progression 1.00;
Transfinite Line { 23} = 27 Using Progression 1.00;
Transfinite Line {-51} = 27 Using Progression 1.01;

Transfinite Line { 26} = 16 Using Progression 1.015;
Transfinite Line { 54} = 16 Using Progression 1.045;

/*vertical*/
Transfinite Line {  3} = 17 Using Progression 1.1;
Transfinite Line { 16} = 17 Using Progression 1.1;
Transfinite Line {  4} = 17 Using Progression 1.1;
Transfinite Line {  6} = 17 Using Progression 1.1;
Transfinite Line { 13} = 17 Using Progression 1.0;
Transfinite Line { 10} = 17 Using Progression 1.0;
...
Transfinite Line { 57} = 15 Using Progression 1.0;
Transfinite Line {-29} = 15 Using Progression 1.02;

Line Loop(41) = {10:12,17:19,22:23,26:29,31,41:44};
Plane Surface(1) = {41};
