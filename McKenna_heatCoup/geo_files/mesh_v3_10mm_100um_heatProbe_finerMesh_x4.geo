...
mat_wide = 0.5*1.25*25.4/1000 * 4.0;
...
burner_mesh_1 = 0.5*1.25*25.4/1000;

Point(2) = {ext_radius, burner_height, 0.0, 0.000200};
Point(3) = {int_radius, burner_height, 0.0, 1.0};
Point(4) = {burner_mesh_1 + mat_BL_layer_x, burner_height, 0.0, 1.0};
...
Point(32) = {burner_mesh_1 + mat_BL_layer_x, burner_height + flame_dist, 0., 1.0};
...
Transfinite Line { 23} = 101 Using Progression 1.00;
Transfinite Line {-50} =  7 Using Progression 1.00;
Transfinite Line {-51} = 95 Using Progression 1.00;
...
/*burner*/
Transfinite Line {-15} = 28 Using Progression 1.01;
Transfinite Line {-12} = 28 Using Progression 1.01;
Transfinite Line { 14} = 23 Using Progression 1.00;
Transfinite Line { 11} = 23 Using Progression 1.00;
...
Transfinite Line { 57} = 57 Using Progression 1.00;
Transfinite Line {-29} = 57 Using Progression 1.00;
...
aux = mat_wide + mat_BL_layer_x - 0.016;

Field[4] = Box;
Field[4].XMax = 0.04 + aux;
Field[4].XMin = 0.016 + aux;
Field[4].YMax = 0.16;
Field[4].YMin = 0.10;
Field[4].ZMax = -1;
Field[4].ZMin = 1;
...
Field[5] = Box;
Field[5].XMax = 0.06 + aux;
Field[5].XMin = 0.016 + aux;
Field[5].YMax = 0.215;
Field[5].YMin = 0.10;
Field[5].ZMax = -1;
Field[5].ZMin = 1;
...
Point(108) = {x3 + 0.00066        ,  mat_location , 0., 1.0};
Point(109) = {mat_wide - 0.0005     ,  mat_location , 0., 1.0};
