...
/*vertical*/
Transfinite Line {  3} = 35 Using Progression 1.1;
Transfinite Line { 16} = 35 Using Progression 1.1;
Transfinite Line {  4} = 35 Using Progression 1.1;
Transfinite Line {  6} = 35 Using Progression 1.1;
Transfinite Line { 13} = 35 Using Progression 1.0;
Transfinite Line { 10} = 35 Using Progression 1.0;
...
Point(104) = {int_radius           ,   0.000010 + burner_height, 0., 1.0};
