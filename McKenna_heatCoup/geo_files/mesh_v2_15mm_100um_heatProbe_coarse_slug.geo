...
/*gap = 0.5; // mm*/
/*x7 = 0.3*25.4/2000 + gap/1000.0; y7 = 0.05*25.4/1000;*/
/*Point(57) = {  x7, mat_location + y7, 0., clM/2.0};*/
x8 = 0.35*25.4/2000; y8 = 0.0;
Point(58) = {  x8, mat_location + y8, 0., clM/2.0};
x9 = 0.3*25.4/2000; y9 = 0.0;
Point(59) = {  x9, mat_location + y9, 0., clM/2.0};
...
Transfinite Line {-47} = 7 Using Progression 1.00;
Transfinite Line {-48} = 2 Using Progression 1.00;
Transfinite Line {-49} = 19 Using Progression 1.00;

Transfinite Line { 62} =  7 Using Progression 1.00;
Transfinite Line { 61} = 17 Using Progression 1.055;
Transfinite Line {-63} = 14 Using Progression 1.05;
Transfinite Line {-46} =  4 Using Progression 1.05;
Transfinite Line { 45} =  4 Using Progression 1.05;

Transfinite Line { 26} = 18 Using Progression 1.052;
Transfinite Line { 54} = 18 Using Progression 1.075;
...
Line Loop(50) = {47,48,49,52,-23,50};
Plane Surface(11) = {50};
Transfinite Surface {11} = {11, 12, 41, 10};
...
Line Loop(60) = {61:63,46,-47};
Plane Surface(20) = {60};
Transfinite Surface {20} = {11, 51, 52, 59} Alternate;

Line Loop(61) = {65,-57,-56,-55,-54,-49,45};
Plane Surface(21) = {61};

Line Loop(62) = {-48,-46,64,-45};
Plane Surface(22) = {62};
