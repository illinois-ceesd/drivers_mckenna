...
Point(21) = {              0.15, radius, 0., 12.5*clF};
...
Point(60) = {   0.75*int_radius, flame_pos + 0.75*delta, 0., clF};
Point(61) = {   0.50*int_radius, flame_pos + 0.75*delta, 0., clF};
Point(62) = {   0.25*int_radius, flame_pos + 0.75*delta, 0., clF};
Point(63) = {   0.25*int_radius, flame_pos + 0.25*delta, 0., clF};
Point(64) = {   0.50*int_radius, flame_pos + 0.25*delta, 0., clF};
Point(65) = {   0.75*int_radius, flame_pos + 0.25*delta, 0., clF};
Point(66) = {   1.00*int_radius, flame_pos + 0.25*delta, 0., clF};
Point(67) = {   1.25*int_radius, flame_pos + 0.25*delta, 0., clF};
Point(68) = {   1.50*int_radius, flame_pos + 0.25*delta, 0., clF};
Point(69) = {   1.75*int_radius, flame_pos + 0.25*delta, 0., clF};
Point{60:69} In Surface{1};

/*Point(71) = {  0.060, burner_height - 0.029, 0., 1.750*clF};*/
Point(72) = {  0.080, burner_height - 0.028, 0., 2.000*clF};
Point(73) = {  0.100, burner_height - 0.025, 0., 2.250*clF};
Point(74) = {  0.118, burner_height - 0.021, 0., 2.500*clF};
Point(75) = {  0.130, burner_height - 0.016, 0., 2.625*clF};
Point(76) = {  0.140, burner_height - 0.010, 0., 2.750*clF};
Point(77) = {  0.150, burner_height + 0.000, 0., 2.875*clF};
Point(78) = {  0.157, burner_height + 0.020, 0., 3.000*clF};
Point(79) = {  0.160, burner_height + 0.050, 0., 3.125*clF};
Point(80) = {  0.160, burner_height + 0.080, 0., 3.250*clF};
Point(81) = {  0.160, burner_height + 0.110, 0., 3.375*clF};
Point(82) = {  0.160, burner_height + 0.140, 0., 3.500*clF};
Point(83) = {  0.160, burner_height + 0.170, 0., 3.625*clF};
Point(84) = {  0.160, burner_height + 0.200, 0., 3.750*clF};
Point(85) = {  0.160, burner_height + 0.230, 0., 4.000*clF};
Point(86) = {  0.160, burner_height + 0.260, 0., 4.250*clF};
Point(87) = {  0.160, burner_height + 0.290, 0., 4.500*clF};
Point(88) = {  0.160, burner_height + 0.320, 0., 4.750*clF};
Point(89) = {  0.160, burner_height + 0.350, 0., 5.000*clF};
Point{72:89} In Surface{1};
